const scatterPlot = function(dataIn,svgIn, xRef,yRef,yTgt,refColor, tgtColor){
    // console.log(dataIn)
    ...
    axesDomain('x',xAxis, 'Products', visWidth,visHeight)
    axesDomain('y',yAxis,'Revenue',visWidth,visHeight)
    ...
    const circlesRef = bubbles   
                    .append('circle') 
                    .attr('cx',d => xScale(d[xRef]))
                    .attr('cy',d => yScale(d[yRef]))
                    .attr('r', 10)
                    .attr('class','ref')
                    .attr('fill',refColor)
                    .attr('opacity',0.7)

    const circlesTgt = bubbles   
                    .append('circle') 
                    .attr('cx',d => xScale(d[xRef]))
                    .attr('cy',d => yScale(d[yTgt]))
                    .attr('r', 10)
                    .attr('class','tgt')
                    .attr('fill',tgtColor)
                    .attr('opacity',0.7)
