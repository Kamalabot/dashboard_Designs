...
createJoin = BashOperator(
    task_id='createJoin',
    bash_command='mkdir -p /home/solverbot/joined && cat /home/solverbot/orders/tempting.txt /home/solverbot/customers/tempting.txt >> /home/solverbot/joined/joined.txt && sleep 15',
    dag=dag
)
...
createDirOrders >> getOrders >> createJoin >> dropOrders
createDirCustomers >> getCustomers >> createJoin >> dropCustomers
